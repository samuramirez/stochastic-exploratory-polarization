...
ax.errorbar(data['params'],Dp,stdDp,color='red',marker="o",markersize=2,capsize=2,label=r'$k_{3}=0 \:\mu m^2/s$')
ax.errorbar(data2['params'],Dp2,stdDp2,color='black',marker="o",markersize=2,capsize=2,label=r'$k_{3}=1 \: \mu m^2/s$')
...
ax.set_yscale('log')
plt.tight_layout()
fig.savefig('Dpatch_newreac_k3_0_1_gef.pdf')
plt.show()
