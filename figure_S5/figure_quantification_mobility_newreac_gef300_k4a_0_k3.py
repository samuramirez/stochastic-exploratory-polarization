...
ax.errorbar(parameters,Dp,stdDp,color='black',marker="o",markersize=2,capsize=2)
ax.set_xlabel(r'$k_{3}$ ($\mu m^2/s$)')
...
plt.tight_layout()
fig.savefig('Dpatch_newreac_gef300_k4a_0_k3.pdf')
