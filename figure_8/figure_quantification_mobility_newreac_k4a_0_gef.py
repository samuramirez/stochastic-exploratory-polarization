...
ax.errorbar(data['params'],Dp,stdDp,color='black',marker="o",markersize=2,capsize=2,label=r'$k_{4a}=2\mu m^2/s$')
ax.errorbar(data2['params'],Dp2,stdDp2,color='red',marker="o",markersize=2,capsize=2,label=r'$k_{4a}=0$')
...
ax.set_yscale('log')
plt.tight_layout()
fig.savefig('Dpatch_newreac_k4a_0_gef.pdf')
plt.show()
