...
while(t < p.interval){
 ...
 //Bleach GEFm and GEF42 at the patch
	if(t > pert_time && pert==0){
	//convert all GEF42 and GEFm at the patch into the dark versions
