...
subfolder = 'gef100_k1b'
with open(folder+subfolder+'.pkl', 'rb') as handle:
    data2 = pickle.load(handle)

subfolder = 'gef300_k1b'
with open(folder+subfolder+'.pkl', 'rb') as handle:
    data3 = pickle.load(handle)

subfolder = 'gef150_k4a_0_k1b'
with open(folder+subfolder+'.pkl', 'rb') as handle:
    data4 = pickle.load(handle)

subfolder = 'gef250_k4a_0_k1b'
with open(folder+subfolder+'.pkl', 'rb') as handle:
    data5 = pickle.load(handle)

subfolder = 'gef400_k4a_0_k1b'
with open(folder+subfolder+'.pkl', 'rb') as handle:
...
ax.set_yscale('log')
plt.tight_layout()
fig.savefig('Dpatch_newreac_controls_k1b_gef.pdf')
plt.show()
...
ax.set_yscale('log')
plt.tight_layout()
fig.savefig('Dpatch_newreac_controls_k1b_k4a_0_gef.pdf')
plt.show()
