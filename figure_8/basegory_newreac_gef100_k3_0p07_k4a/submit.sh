...
sbatch -t 58:00:00 -n 1 -o k4a_"$kmi5".out --wrap="./run $nsim $N $L $interval $samp $sigma $Dm $Dc $tot42 $totgef $kmi0 $kmi1 $kmi2 $kmi3 $kmi4 $kmi5 $kmi6 $kmi7 $kmi8 $kmi9 $kmi10 k4a $kmi5"
