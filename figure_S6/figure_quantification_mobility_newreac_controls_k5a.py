...
subfolder = 'gef100_k5a'
with open(folder+subfolder+'.pkl', 'rb') as handle:
    data2 = pickle.load(handle)

subfolder = 'gef300_k5a'
with open(folder+subfolder+'.pkl', 'rb') as handle:
    data3 = pickle.load(handle)

subfolder = 'gef150_k4a_0_k5a'
with open(folder+subfolder+'.pkl', 'rb') as handle:
    data4 = pickle.load(handle)

subfolder = 'gef250_k4a_0_k5a'
with open(folder+subfolder+'.pkl', 'rb') as handle:
    data5 = pickle.load(handle)

subfolder = 'gef400_k4a_0_k5a'
with open(folder+subfolder+'.pkl', 'rb') as handle:
...
matplotlib.rcParams.update({'font.size': 7})
fig,ax = plt.subplots() 
ax.errorbar(np.asarray(data['params'])[2:],Dp,stdDp,color='black',marker="o",markersize=2,capsize=2,label=r'GEF=50',linestyle='dotted')
...
ax.set_yscale('log')
plt.tight_layout()
fig.savefig('Dpatch_newreac_controls_k5a_gef.pdf')
plt.show()
...
ax.set_yscale('log')
plt.tight_layout()
fig.savefig('Dpatch_newreac_controls_k5a_k4a_0_gef.pdf')
plt.show()
