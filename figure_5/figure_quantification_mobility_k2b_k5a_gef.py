...
subfolder = 'basegory_k2b_0p0625x_gef_long'
...
#ax.errorbar(data['params'],Dp,stdDp,color='black',marker="o",markersize=2,capsize=2,label=r'$k_{6}=1\mu m^2/s$ ',linestyle='dotted')
...
#stddevgef42t= (np.asarray(data2['mgef42t2']) - np.asarray(data2['mgef42t'])**2)**0.5
#ax2.errorbar(data2['params'],data2['mgef42t'],stddevgef42t,color='orange',marker="o",markersize=2,capsize=2,linestyle='-')
...
plt.tight_layout()
#fig.savefig('Dpatch_k2b_k5a_gef.pdf')
plt.show()

#SAVE DATA
dataD = {'params':data2['params'], 'Dp':Dp2, 'stdDp':stdDp2, 'a':a2, 'stda':stda2}
