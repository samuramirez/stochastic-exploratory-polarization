...
do
for kmi4  in  0.005 0.01 0.02 0.04 0.07 0.1 1  #k3 
do
for kmi5  in 0 #k4a 
do
for kmi6  in 10  #k4b
...
sbatch -t 72:00:00 -n 1 -o k3_"$kmi4".out --wrap="./run $nsim $N $L $interval $samp $sigma $Dm $Dc $tot42 $totgef $kmi0 $kmi1 $kmi2 $kmi3 $kmi4 $kmi5 $kmi6 $kmi7 $kmi8 $kmi9 $kmi10 k3 $kmi4"
