...
with open(folder+subfolder+'_dataD.pkl', 'rb') as handle:
    datanewreac = pickle.load(handle)

folder = 'D:dynamic_polarity_data/'
subfolder = 'basegory_newreac_k4a_0_gef'
with open(folder+subfolder+'_dataD.pkl', 'rb') as handle:
    datanewreack4a0 = pickle.load(handle)
...
subfolder = 'gef100_k4b'
with open(folder+subfolder+'.pkl', 'rb') as handle:
    data2 = pickle.load(handle)

subfolder = 'gef300_k4b'
with open(folder+subfolder+'.pkl', 'rb') as handle:
    data3 = pickle.load(handle)

subfolder = 'gef150_k4a_0_k4b'
with open(folder+subfolder+'.pkl', 'rb') as handle:
    data4 = pickle.load(handle)

subfolder = 'gef250_k4a_0_k4b'
with open(folder+subfolder+'.pkl', 'rb') as handle:
    data5 = pickle.load(handle)

subfolder = 'gef400_k4a_0_k4b'
with open(folder+subfolder+'.pkl', 'rb') as handle:
...
matplotlib.rcParams.update({'font.size': 7})
fig,ax = plt.subplots() 
newreacindx50=datanewreac['params'].index(50)
newreacindx100=datanewreac['params'].index(100)
newreacindx300=datanewreac['params'].index(300)
ax.errorbar([10]+data['params'],[datanewreac['Dp'][newreacindx50]]+Dp,[datanewreac['stdDp'][newreacindx50]]+stdDp,color='black',marker="o",markersize=2,capsize=2,label=r'GEF=50',linestyle='dotted')
ax.errorbar([10]+data2['params'],[datanewreac['Dp'][newreacindx100]]+Dp2,[datanewreac['stdDp'][newreacindx100]]+stdDp2,color='black',marker="o",markersize=2,capsize=2,label=r'GEF=100',linestyle='--')
ax.errorbar(data3['params'],Dp3,stdDp3,color='black',marker="o",markersize=2,capsize=2,label=r'GEF=300',linestyle='-')
ax.set_xlabel(r'$k_{4b}(1/s)$')
...
ax.set_yscale('log')
plt.tight_layout()
fig.savefig('Dpatch_newreac_controls_k4b_gef.pdf')
plt.show()
...
matplotlib.rcParams.update({'font.size': 7})
fig,ax = plt.subplots() 
newreack4a0indx150=datanewreack4a0['params'].index(150)
ax.errorbar(data4['params'][0:2]+[10],Dp4+[datanewreack4a0['Dp'][newreack4a0indx150]],stdDp4+[datanewreack4a0['stdDp'][newreack4a0indx150]],color='black',marker="o",markersize=2,capsize=2,label=r'GEF=150',linestyle='dotted')
ax.errorbar(data5['params'][0:2],Dp5,stdDp5,color='black',marker="o",markersize=2,capsize=2,label=r'GEF=250',linestyle='--')
ax.errorbar(data6['params'][0:3],Dp6,stdDp6,color='black',marker="o",markersize=2,capsize=2,label=r'GEF=400',linestyle='-')
ax.set_xlabel(r'$k_{4b} (1/s)$')
...
ax.set_yscale('log')
plt.tight_layout()
fig.savefig('Dpatch_newreac_controls_k4b_k4a_0_gef.pdf')
plt.show()
